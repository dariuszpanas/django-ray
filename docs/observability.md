...
request live node data through an authorized application surface when needed. This keeps
page refresh traffic bounded and makes database state visible even during Ray outages.
