# Generated by Django 6.0 on 2025-12-21 23:19
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "callable_path",
                    models.CharField(
                        help_text="Dotted path to the task callable", max_length=500
                    ),
                ),
                (
                    "queue_name",
                ...
                (
                    "kwargs_json",
                    models.TextField(
                        default="{}", help_text="JSON-serialized keyword arguments"
                    ),
                ),
                (
                    "result_data",
