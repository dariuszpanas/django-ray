...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        while traceback is not None:
            ...
            if module == "__main__" and traceback.tb_frame.f_globals.get("__file__") == __file__:
                module = "qualification.application.run_workflows"
            if (
                module.startswith("qualification.application.")
                or module == "testproject.docker_smoke"
            ):
